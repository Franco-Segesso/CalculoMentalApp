    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.row}>
                <TouchableOpacity style={[styles.btn, {flex: 1, marginRight: 8}]} onPress={() => navigation.goBack()}>
                    <Text style={styles.btnText}>Volver al Menú</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.btn, styles.btnDanger, {flex: 1, marginLeft: 8}]} onPress={clearHistory}>
